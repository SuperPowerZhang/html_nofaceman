...
},{"process":"../../../AppData/Roaming/npm/node_modules/parcel/node_modules/process/browser.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
var player = {
  ...
  bind: function bind() {
    for (var k in player.events) {
      (0, _jquery.default)("".concat(k)).on('click', player[player.events[k]]);
      (0, _jquery.default)("".concat(k)).on('touchstart', player[player.events[k]]);
    }
  }
};
player.step(speed);
...
},{"./text":"text.js","./jquery":"jquery.js"}],"../../../AppData/Roaming/npm/node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
